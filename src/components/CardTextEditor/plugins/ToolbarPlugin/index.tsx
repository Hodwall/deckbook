...
import { $createParagraphNode, $getNodeByKey, $getRoot, $getSelection, $isElementNode, $isRangeSelection, $isRootOrShadowRoot, $isTextNode, CAN_REDO_COMMAND, CAN_UNDO_COMMAND, COMMAND_PRIORITY_CRITICAL, COMMAND_PRIORITY_NORMAL, DEPRECATED_$isGridSelection, ElementFormatType, FORMAT_ELEMENT_COMMAND, FORMAT_TEXT_COMMAND, INDENT_CONTENT_COMMAND, KEY_MODIFIER_COMMAND, LexicalEditor, NodeKey, OUTDENT_CONTENT_COMMAND, REDO_COMMAND, SELECTION_CHANGE_COMMAND, UNDO_COMMAND } from 'lexical';
import { Dispatch, useCallback, useEffect, useState } from 'react';
import { IS_APPLE } from '../../shared/environment';

import useModal from '../../hooks/useModal';
import { $createStickyNode } from '../../nodes/StickyNode';
import DropDown, { DropDownItem } from '../../../CardTextEditor/ui/DropDown';
import DropdownColorPicker from '../../../CardTextEditor/ui/DropdownColorPicker';
  ...
  return (
    <DropDown
      ...
      <DropDownItem
        ...
        <i className="icon paragraph"><MdNotes /></i>
      ...
      <DropDownItem
        ...
        <i className="icon bullet-list"><MdFormatListBulleted /></i>
        <span className="text">Bullet List</span>
      </DropDownItem>
      <DropDownItem
        className={'item ' + dropDownActiveClass(blockType === 'number')}
        onClick={formatNumberedList}>
        <i className="icon numbered-list"><MdFormatListNumbered /></i>
        <span className="text">Numbered List</span>
      </DropDownItem>
      <DropDownItem
        className={'item ' + dropDownActiveClass(blockType === 'check')}
        onClick={formatCheckList}>
        <i className="icon check-list"><MdChecklist /></i>
        <span className="text">Check List</span>
      </DropDownItem>
      <DropDownItem
        className={'item ' + dropDownActiveClass(blockType === 'quote')}
        onClick={formatQuote}>
        <i className="icon quote"><MdFormatQuote /></i>
  ...
  return (
    <DropDown
      ...
      <DropDownItem
        ...
        className="item">
        <i className="icon left-align"><MdFormatAlignLeft /></i>
      ...
      <DropDownItem
        ...
        className="item">
        <i className="icon center-align"><MdFormatAlignCenter /></i>
      ...
      <DropDownItem
        ...
        className="item">
        <i className="icon right-align"><MdFormatAlignRight /></i>
      ...
      <DropDownItem
        ...
        className="item">
        <i className="icon justify-align"><MdFormatAlignJustify /></i>
    ...
    <div className={`toolbar ${isEditable ? '' : 'disabled'}`}>
      ...
      <>
        <button
          ...
          <i className="format bold"><MdFormatBold /></i>
        </button>
        <button
          disabled={!isEditable}
          onClick={() => {
          ...
          <i className="format italic"><MdFormatItalic /></i>
        </button>
        <button
          disabled={!isEditable}
          onClick={() => {
          ...
          <i className="format underline"><MdFormatUnderlined /></i>
        </button>
        <button
          disabled={!isEditable}
          onClick={() => {
          ...
          title={IS_APPLE ? 'Strikethrough (⌘U)' : 'Strikethrough (Ctrl+U)'}
          type="button"
          aria-label={`Format text with a strikethrough'}`}>
          <i className="format strikethrough"><MdStrikethroughS /></i>
        </button>
        <button
          disabled={!isEditable}
          onClick={insertLink}
          ...
          title="Insert link"
          type="button">
          <i className="format link"><MdAddLink /></i>
        </button>
        <DropdownColorPicker
          disabled={!isEditable}
          buttonClassName="toolbar-item color-picker"
          // buttonAriaLabel="Formatting text color"
          buttonLabel={<MdFormatColorText />}
        ...
        <DropDown
          disabled={!isEditable}
          buttonLabel={<MdAddCircleOutline />}
          buttonClassName="toolbar-item spaced"
      ...
      <button
        ...
        className={'toolbar-item lock spaced '}
      >
        {isEditable ? <MdLockOpen /> : <MdLock />}
      </button>
      {modal}
    </div>
  );
